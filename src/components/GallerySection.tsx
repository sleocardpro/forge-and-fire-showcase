...
const galleryImages = [
  { src: verriereImg, alt: "Verrière style atelier", tall: true },
  { src: escalierImg, alt: "Escalier hélicoïdal", tall: true },
  { src: weldingBlueImg, alt: "Soudure à l'arc", tall: false },
  { src: portailImg, alt: "Portail provençal", tall: false },
  { src: detailImg, alt: "Détail de soudure", tall: false },
  { src: mobilierImg, alt: "Table industrielle", tall: false },
  { src: gardeCorpsImg, alt: "Garde-corps moderne", tall: true },
  { src: weldingCloseImg, alt: "Travail de précision", tall: false },
];
...
const GallerySection = () => {
  ...
  return (
    <section id="galerie" className="py-20 md:py-28 bg-secondary/30">
      ...
      {selectedImage && (
        ...
        >
          <button
            className="absolute top-4 right-4 text-foreground/60 hover:text-foreground text-4xl"
            onClick={() => setSelectedImage(null)}
          >
            ×
          </button>
