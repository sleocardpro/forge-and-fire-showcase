        ...
        <div className="grid md:grid-cols-2 gap-12 items-center">
          ...
          <div className="relative">
            <div className="relative overflow-hidden rounded-xl">
              <img
                src={artisanImg}
                alt="L'artisan métallier au travail"
          ...
          <div className="space-y-6">
            ...
            <div className="space-y-4 text-foreground/80 leading-relaxed">
              ...
              <p>
                Du premier croquis à la pose finale, je vous accompagne pour créer 
                des pièces <strong className="text-foreground">uniques et durables</strong>, 
            ...
            <p className="text-muted-foreground text-sm">
              Brignoles • Draguignan • Saint-Maximin • Aix-en-Provence • Toulon
            </p>
          </div>
        </div>
      </div>
